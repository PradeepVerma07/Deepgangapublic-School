...
dd($exception);
    ...
    public function studentAttendanceBulkStore(Request $request)
    {
        ...
        */
            if (moduleStatusCheck('University')) {
                Excel::import(new UniversityStudentAttendanceImport($request->un_session_id, $request->un_faculty_id, $request->un_department_id, $request->un_academic_id, $request->un_semester_id, $request->un_semester_label_id, $request->un_section_id), $request->file('file'), null, \Maatwebsite\Excel\Excel::XLSX);
            } else {
