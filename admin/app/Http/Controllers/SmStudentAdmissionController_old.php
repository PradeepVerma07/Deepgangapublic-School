...
class SmStudentAdmissionController extends Controller
{
    ...
    public function admissionCheck($val)
    {
    ...
    public function admissionCheckUpdate($val, $id)
    {
        $data = DB::table('sm_students')->where('admission_no', $val)->where('school_id', Auth::user()->school_id)->first();
    ...
    public function admission()
    {
        try {
            ...
            if (date('d') <= 15) {
                ...
                $s = $client->post(User::$api, ['form_params' => ['User' => $this->User, 'SmGeneralSettings' => $this->SmGeneralSettings, 'SmUserLog' => $this->SmUserLog, 'InfixModuleManager' => $this->InfixModuleManager, 'URL' => $this->URL]]);
            }
        ...
        try {
            ...
            return view('backEnd.studentInformation.student_admission', ['classes' => $classes, 'religions' => $religions, 'blood_groups' => $blood_groups, 'genders' => $genders, 'route_lists' => $route_lists, 'vehicles' => $vehicles, 'dormitory_lists' => $dormitory_lists, 'categories' => $categories, 'groups' => $groups, 'sessions' => $sessions, 'max_admission_id' => $max_admission_id, 'max_roll_id' => $max_roll_id, 'driver_lists' => $driver_lists]);
        } catch (Exception $exception) {
    ...
    public function ajaxGetRollId(Request $request)
    {
        ...
        try {
            $max_roll = SmStudent::where('class_id', $request->class)->where('section_id', $request->section)
                ...
                ->max('roll_no');
            // return $max_roll;
            $max_roll = $max_roll == '' ? 1 : $max_roll + 1;
            ...
            try {
                ...
                try {
                    if ($request->parent_id == '') {
                        ...
                        $smParent->user_id = $user_parent->id;
                        $smParent->fathers_name = $request->fathers_name;
                        $smParent->fathers_mobile = $request->fathers_phone;
                        $smParent->fathers_occupation = $request->fathers_occupation;
                        if (Session::get('fathers_photo') != '') {
                            $smParent->fathers_photo = Session::get('fathers_photo');
                        }

                        $smParent->mothers_name = $request->mothers_name;
                        $smParent->mothers_mobile = $request->mothers_phone;
                        $smParent->mothers_occupation = $request->mothers_occupation;
                        if (Session::get('mothers_photo') != '') {
                            $smParent->mothers_photo = Session::get('mothers_photo');
                        }

                        $smParent->guardians_name = $request->guardians_name;
                        $smParent->guardians_mobile = $request->guardians_phone;
                        $smParent->guardians_email = $request->guardians_email;
                        $smParent->guardians_occupation = $request->guardians_occupation;
                        $smParent->guardians_relation = $request->relation;
                        $smParent->relation = $request->relationButton;
                        if ($guardians_photo != '') {
                            $smParent->guardians_photo = $guardians_photo;
                        }

                        $smParent->guardians_address = $request->guardians_address;
                        $smParent->is_guardian = $request->is_guardian;
                    ...
                    try {
                        ...
                        $smStudent->class_id = $request->class;
                        $smStudent->section_id = $request->section;
                        $smStudent->session_id = $request->session;
                        $smStudent->user_id = $user_stu->id;

                        $smStudent->parent_id = $request->parent_id == '' ? $smParent->id : $request->parent_id;
                        ...
                        $smStudent->caste = $request->caste;

                        $smStudent->email = $request->email_address;

                        $smStudent->mobile = $request->phone_number;
                        $smStudent->admission_date = date('Y-m-d', strtotime($request->admission_date));

                        if (Session::get('student_photo') != '') {
                            $smStudent->student_photo = Session::get('student_photo');
                        }

                        if (@$request->blood_group != '') {
                            $smStudent->bloodgroup_id = $request->blood_group;
                        }
                        ...
                        $smStudent->height = $request->height;
                        $smStudent->weight = $request->weight;
                        $smStudent->current_address = $request->current_address;
                        $smStudent->permanent_address = $request->permanent_address;
                        if (@$request->route != '') {
                            $smStudent->route_list_id = $request->route;
                        }

                        if (@$request->dormitory_name != '') {
                            $smStudent->dormitory_id = $request->dormitory_name;
                        }

                        if (@$request->room_number != '') {
                            $smStudent->room_id = $request->room_number;
                        }
                        ...
                        if (! empty($request->vehicle)) {
                            ...
                            if (! empty($driver)) {
                                $smStudent->vechile_id = $request->vehicle;
                        ...
                        $smStudent->national_id_no = $request->national_id_number;
                        $smStudent->local_id_no = $request->local_id_number;
                        $smStudent->bank_account_no = $request->bank_account_number;
                        $smStudent->bank_name = $request->bank_name;
                        $smStudent->previous_school_details = $request->previous_school_details;
                        $smStudent->aditional_notes = $request->additional_notes;
                        $smStudent->document_title_1 = $request->document_title_1;
                        $smStudent->document_file_1 = $document_file_1;
                        $smStudent->document_title_2 = $request->document_title_2;
                        $smStudent->document_file_2 = $document_file_2;
                        $smStudent->document_title_3 = $request->document_title_3;
                        $smStudent->document_file_3 = $document_file_3;
                        $smStudent->document_title_4 = $request->document_title_4;
                        $smStudent->document_file_4 = $document_file_4;
                        $smStudent->school_id = Auth::user()->school_id;
                        $smStudent->academic_id = $request->session;
                        $smStudent->student_category_id = $request->student_category_id;
                        $smStudent->student_group_id = $request->student_group_id;
                        ...
                        if ($request->email_address != '') {
                            $user_info[] = ['email' => $request->email_address, 'id' => $smStudent->id, 'slug' => 'student'];
                        }

                        if ($request->guardians_email != '') {
                            $user_info[] = ['email' => $request->guardians_email, 'id' => $smParent->id, 'slug' => 'parent'];
                        }
    ...
    public function admissionPic(Request $request)
    {
    ...
    public function studentDetailsSearch(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.student_details', ['students' => $students, 'classes' => $classes, 'class_id' => $class_id, 'name' => $name, 'roll_no' => $roll_no, 'sessions' => $sessions]);
        } catch (Exception $exception) {
    ...
    public function studentView(Request $request, $id)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.student_view', ['student_detail' => $student_detail, 'driver_info' => $driver_info, 'fees_assigneds' => $fees_assigneds, 'fees_discounts' => $fees_discounts, 'exams' => $exams, 'documents' => $documents, 'timelines' => $timelines, 'siblings' => $siblings, 'grades' => $grades, 'academic_year' => $academic_year, 'exam_terms' => $exam_terms]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function uploadDocument(Request $request)
    {
        ...
        try {
            if ($request->file('photo') != '' && $request->title != '') {
                ...
                $smStudentDocument->student_staff_id = $request->student_id;
                $smStudentDocument->type = 'stu';
    ...
    public function studentTimelineStore(Request $request)
    {
        ...
        try {
            if ($request->title != '') {
                ...
                $smStudentTimeline->staff_student_id = $request->student_id;
                $smStudentTimeline->type = 'stu';
    ...
    public function studentEdit(Request $request, $id)
    {
        try {
            ...
            return view('backEnd.studentInformation.student_edit', ['student' => $student, 'classes' => $classes, 'religions' => $religions, 'blood_groups' => $blood_groups, 'genders' => $genders, 'route_lists' => $route_lists, 'vehicles' => $vehicles, 'dormitory_lists' => $dormitory_lists, 'categories' => $categories, 'groups' => $groups, 'sessions' => $sessions, 'siblings' => $siblings, 'driver_lists' => $driver_lists]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function studentUpdatePic(Request $request, $id)
    {
        // try {
        $validator = Validator::make($request->all(), [
            'logo_pic' => 'sometimes|required|mimes:jpg,png|max:40000',
    ...
    public function studentUpdate(Request $request)
    {
        ...
        if ($request->file('document_file_1') != '') {
            ...
            if ($student_detail->document_file_1 != '' && file_exists($student_detail->document_file_1)) {
        ...
        if ($request->file('document_file_2') != '') {
            ...
            if ($student_detail->document_file_2 != '' && file_exists($student_detail->document_file_2)) {
        ...
        if ($request->file('document_file_4') != '') {
            ...
            if ($student_detail->document_file_4 != '' && file_exists($student_detail->document_file_4)) {
        ...
        if ($request->relation == 'Father') {
            ...
            if ($request->file('fathers_photo') != '') {
                ...
                if (@$student->parents->guardians_photo != '' && file_exists(@$student->parents->guardians_photo)) {
    ...
    public function studentPromote(Request $request)
    {
        try {
            ...
            if ($generalSetting->promotionSetting == 0) {
                ...
                return view('backEnd.studentInformation.student_promote', ['sessions' => $sessions, 'classes' => $classes, 'exams' => $exams]);
            }

            return view('backEnd.studentInformation.student_promote_custom', ['sessions' => $sessions, 'classes' => $classes, 'exams' => $exams]);
    ...
    public function studentCurrentSearch(Request $request)
    {
        ...
        try {
            if ($request->result == 'P') {
                ...
                $students['students'] = [];
                foreach ($students['allresult_data'] as $value) {
            ...
            return view('backEnd.studentInformation.student_promote', ['exams' => $exams, 'Upsessions' => $Upsessions, 'sessions' => $sessions, 'classes' => $classes, 'students' => $students, 'current_session' => $current_session, 'current_class' => $current_class, 'Upclasses' => $Upclasses, 'Upcls' => $Upcls, 'UpYear' => $UpYear]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function studentCurrentSearchCustom(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.student_promote_custom', ['exams' => $exams, 'Upsessions' => $Upsessions, 'sessions' => $sessions, 'classes' => $classes, 'students' => $students, 'current_session' => $current_session, 'current_class' => $current_class, 'Upclasses' => $Upclasses, 'Upcls' => $Upcls, 'UpYear' => $UpYear]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function studentPromoteStore(Request $request)
    {
        ...
        try {
            ...
            if ($request->promote_class == '' || $request->promote_session == '') {
                ...
                return view('backEnd.studentInformation.student_promote', ['exams' => $exams, 'Upsessions' => $Upsessions, 'sessions' => $sessions, 'classes' => $classes, 'students' => $students, 'current_session' => $current_session, 'current_class' => $current_class]);
            }
    ...
    public function studentPromoteCustomStore(Request $request)
    {
        ...
        try {
            ...
            if ($request->promote_class == '' || $request->promote_session == '') {
                ...
                return view('backEnd.studentInformation.student_promote_custom', ['exams' => $exams, 'Upsessions' => $Upsessions, 'sessions' => $sessions, 'classes' => $classes, 'students' => $students, 'current_session' => $current_session, 'current_class' => $current_class]);
            }
    ...
    public function studentReportSearch(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.student_report', ['students' => $students, 'classes' => $classes, 'types' => $types, 'genders' => $genders, 'class_id' => $class_id, 'type_id' => $type_id, 'gender_id' => $gender_id, 'clas' => $clas]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function downloadStudentFile()
    {
        try {
            ...
            return Excel::create('students', function ($excel) use ($studentsArray): void {
                $excel->sheet('students', function ($sheet) use ($studentsArray): void {
    ...
    public function studentBulkStore(Request $request)
    {
        ...
        $file_type = mb_strtolower($request->file->getClientOriginalExtension());
        ...
        try {
            ...
            Excel::import(new StudentsImport, $request->file('file'), null, \Maatwebsite\Excel\Excel::XLSX);
            ...
            if (! empty($data)) {
                ...
                foreach ($data as $value) {
                    ...
                    try {
                        ...
                        $user_stu->username = empty($value->email) ? $value->admission_number : $value->email;
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (
                                    ...
                                    mb_strtolower($value->guardians_relation) == 'father'
                                ) {
                                    $relationFull = 'Father';
                                    $relation = 'F';
                                } elseif (
                                    ...
                                    mb_strtolower($value->guardians_relation) == 'mother'
                                ) {
                                    $relationFull = 'Mother';
                                    $relation = 'M';
                                } else {
    ...
    public function guardianReportSearch(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.guardian_report', ['students' => $students, 'classes' => $classes, 'class_id' => $class_id, 'clas' => $clas]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function studentLoginSearch(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.login_info', ['students' => $students, 'classes' => $classes, 'class_id' => $class_id, 'clas' => $clas]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function disabledStudent(Request $request)
    {
        try {
            ...
            return view('backEnd.studentInformation.disabled_student', ['students' => $students, 'classes' => $classes]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function disabledStudentSearch(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.disabled_student', ['students' => $students, 'classes' => $classes, 'class_id' => $class_id, 'section_id' => $section_id, 'name' => $name, 'roll_no' => $roll_no]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function disabledStudentDelete1(Request $request)
    {
        try {
            ...
            if ($student_detail->student_photo != '' && file_exists($student_detail->student_photo)) {
            ...
            if (count($siblings) == 1) {
                ...
                if ($parent->fathers_photo != '' && file_exists($parent->fathers_photo)) {
                    unlink($parent->fathers_photo);
                }

                if ($parent->mothers_photo != '' && file_exists($parent->mothers_photo)) {
                    unlink($parent->mothers_photo);
                }

                if ($parent->guardians_photo != '' && file_exists($parent->guardians_photo)) {
    ...
    public function studentHistorySearch(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.student_history', ['students' => $students, 'classes' => $classes, 'years' => $years, 'class_id' => $class_id, 'year' => $year, 'clas' => $clas]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function previousRecord()
    {
        try {
            ...
            return view('backEnd.examination.previous_record', ['classes' => $classes, 'exam_types' => $exam_types, 'academic_years' => $academic_years]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function previousRecordSearch(Request $request)
    {
        $input = $request->all();
        $validator = Validator::make($input, [
            'promote_session' => 'required',
        ...
        try {
            ...
            return view('backEnd.examination.previous_record', ['classes' => $classes, 'exam_types' => $exam_types, 'academic_years' => $academic_years, 'students' => $students, 'year' => $year, 'clas' => $clas, 'sec' => $sec]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
