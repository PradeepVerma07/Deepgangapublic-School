...
class SmStudentAttendanceController extends Controller
{
    ...
    public function studentSearch(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.student_attendance', ['classes' => $classes, 'sections' => $sections, 'class_id' => $class_id, 'section_id' => $section_id, 'date' => $date, 'already_assigned_students' => $already_assigned_students, 'new_students' => $new_students, 'attendance_type' => $attendance_type, 'search_info' => $search_info]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function studentAttendanceBulkStore(Request $request)
    {
        ...
        try {
            ...
            Excel::import(new StudentAttendanceImport($request->class, $request->section), $request->file('file'), null, \Maatwebsite\Excel\Excel::XLSX);
