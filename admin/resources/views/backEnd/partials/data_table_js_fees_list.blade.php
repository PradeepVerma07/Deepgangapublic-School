...
$("#table_id, .school-table-data, #tableWithoutSort, #noSearch").each(function() {
  var $table = $(this);

  $table.find('thead th').each(function(index) {
    var heading = $(this).text().trim().toLowerCase();

    if (heading === 'action' || heading === 'actions' || $(this).hasClass('not-export-col')) {
      ...
      buttons: [
        ...
        },
        {
            ...
            customize: function (doc) {
                ...
                if (doc.content[2] && doc.content[2].margin) {
                doc.content[2].margin = [10, 0, 10, 0];
                }
