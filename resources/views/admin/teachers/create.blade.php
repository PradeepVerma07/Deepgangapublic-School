...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-lg-6"><h5>Create Teacher</h5></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker @error('dob') is-invalid @enderror" id="dob" name="dob" value="{{ old('dob') }}" placeholder="dd/mm/yyyy">
                        @error('dob')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
