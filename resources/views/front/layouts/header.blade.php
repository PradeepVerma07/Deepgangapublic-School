<header class="site-header header-style-1  mobile-sider-drawer-menu">
                        ...
                        <ul>
                            <li class="d-none d-lg-inline-block d-lg-inline-block">
                                <div class="it-header-top-contact d-flex align-items-center">
                                    ...
                                    <a class="border-line" href="tel:+91  9839933425">+91  9839933425</a>
                                </div>
                            </li>
                            <li>
                                <div class="it-header-top-contact d-flex align-items-center">
                                    ...
                                    <a class="border-line" href="mailto:dgpsmalap@gmail.com">dgpsmalap@gmail.com</a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <a href="https://deepgangapublicschool.com/admin/login">Login</a>
</div>
        ...
        <div class="main-bar bg-white">
            <div class="container-fluid">
                <div class="logo-header">
                    <a href="{{ route('home') }}">
                        <img src="{{ getImageUrl($school->photo) }}" alt="Deep Ganga Public School" class="school-logo"
                            style="object-fit: contain; height: auto; transition: all 0.3s ease;">
                    </a>
                </div>
                ...
                <nav class="header-nav" id="mobileMenu">
                    ...
                    <!-- CLOSE BUTTON -->
                    <button class="mobile-nav-close d-lg-none" onclick="closeMobileNav()">×</button>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        @foreach ($menus[null] ?? [] as $menu)
                            @php
                                $url = $menu['slug'] === 'about-us' ? route('about-us') :
                                       ($menu['slug'] === 'contact-us' ? route('contact-us') : url($menu['slug']));
                            @endphp
                            <li>
